        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-gray-200">Landing Pages que</span>
              <br />
              <span className="text-accent-orange">Convertem Visitantes em Clientes</span>
            </h2>

            <p className="text-xl text-gray-400 mb-8 max-w-3xl">
              Desenvolvemos landing pages otimizadas para conversão com design moderno, 
              performance excepcional e estratégias de UX comprovadas para maximizar seus resultados.
            </p>
