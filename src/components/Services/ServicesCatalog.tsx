...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Interfaces em React apoiadas em um processo de UX Design centrado no usuário — pesquisa, personas, wireframes e testes de usabilidade — da landing page à aplicação completa.',
